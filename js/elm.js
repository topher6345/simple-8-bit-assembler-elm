...
var $author$project$Init$program = 'MOV [232], \'h\'\nMOV [233], \'e\'\nMOV [234], \'l\'\nMOV [235], \'l\'\nMOV [236], \'o\'\nMOV [237], \' \'\nMOV [238], \'w\'\nMOV [239], \'o\'\nMOV [240], \'r\'\nMOV [241], \'l\'\nMOV [242], \'d\'\nMOV [232], \' \'\nMOV [233], \' \'\nMOV [234], \' \'\nMOV [235], \' \'\nMOV [236], \' \'\nMOV [237], \' \'\nMOV [238], \' \'\nMOV [239], \' \'\nMOV [240], \' \'\nMOV [241], \' \'\nMOV [242], \' \'\nMOV [232], \'h\'\nMOV [233], \'e\'\nMOV [234], \'l\'\nMOV [235], \'l\'\nMOV [236], \'o\'\nMOV [237], \' \'\nMOV [238], \'w\'\nMOV [239], \'o\'\nMOV [240], \'r\'\nMOV [241], \'l\'\nMOV [242], \'d\'\nMOV [232], \' \'\nMOV [233], \' \'\nMOV [234], \' \'\nMOV [235], \' \'\nMOV [236], \' \'\nMOV [237], \' \'\nMOV [238], \' \'\nMOV [239], \' \'\nMOV [240], \' \'\nMOV [241], \' \'\nMOV [242], \' \'\nMOV [242], \'d\'\nMOV [241], \'l\'\nMOV [240], \'r\'\nMOV [239], \'o\'\nMOV [238], \'w\'\nMOV [237], \' \'\nMOV [236], \'o\'\nMOV [235], \'l\'\nMOV [234], \'l\'\nMOV [233], \'e\'\nMOV [232], \'h\'\nHLT\n';
...
var $author$project$Assembler$opcodeToBytes = function (opc) {
	switch (opc.$) {
		case 'A0':
			...
			return _List_fromArray(
				[
					$author$project$Assembler$lookup1ArgOpcodes(op0.x)
				]);
		case 'A1':
			var op1 = opc.a;
			return _List_fromArray(
				[
					$author$project$Assembler$lookup1ArgOpcodes(op1.x),
					$author$project$Assembler$argumentToBytes(op1.y)
				]);
		default:
			var op2 = opc.a;
			return _List_fromArray(
				[
					$author$project$Assembler$lookup1ArgOpcodes(op2.x),
					$author$project$Assembler$argumentToBytes(op2.y),
					$author$project$Assembler$argumentToBytes(op2.z)
				]);
	}
};
					...
					cpu,
					{
						ram: $author$project$CPU$loadRam(
							$elm$core$Array$fromList(
								$author$project$Assembler$assembleCode(model.code)))
					});
				return _Utils_Tuple2(
					_Utils_update(
						model,
	...
	[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('This is a tribute to '),
						A2(
						$elm$html$Html$a,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://schweigi.github.io/assembler-simulator/index.html'),
								$elm$html$Html$Attributes$target('_blank')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Simple 8-bit Assembler Simulator')
							])),
						$elm$html$Html$text(' by Marco Schweighauser')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('This simulator provides a simplified assembler syntax (based on '),
								A2(
								$elm$html$Html$a,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$href('https://www.nasm.us/'),
										$elm$html$Html$Attributes$target('_blank')
									]),
								_List_fromArray(
									[
									...
									[
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$href('http://en.wikipedia.org/wiki/Assembly_language')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('Assembly - Wikipedia')
													]))
											])),
										A2(
										$elm$html$Html$li,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$href('http://cs.smith.edu/~thiebaut/ArtOfAssembly/artofasm.html')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('The Art of Assembly Language Programming')
													]))
											])),
										A2(
										$elm$html$Html$li,
										...
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$href('http://www.nasm.us/xdoc/2.10.09/html/nasmdoc3.html')
													]),
												_List_fromArray(
													[
														$elm$html$Html$text('NASM Language Documentation')
													]))
											]))
									])),
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Instruction Set')
					])),
				A2(
				$elm$html$Html$h4,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('MOV - Copy a value')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				...
				_List_fromArray(
					[
						$elm$html$Html$text('MOV reg, reg\nMOV reg, address\nMOV reg, constant\nMOV address, reg\nMOV address, constant')
					])),
				A2(
				$elm$html$Html$h4,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('HLT - Stops the processor. ')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Stops operation of the processor. Hit Reset button to reset IP before restarting.')
					])),
				A2(
				$elm$html$Html$pre,
				_List_Nil,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$href('https://schweigi.github.io/assembler-simulator/instruction-set.html'),
								$elm$html$Html$Attributes$target('_blank')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Original Documentation')
							]))
					]))
			]))
	]);
