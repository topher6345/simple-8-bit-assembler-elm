...
{
	if (region.av.V === region.aH.V)
	{
		return 'on line ' + region.av.V;
	}
	return 'on lines ' + region.av.V + ' through ' + region.aH.V;
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aL: fragment, aQ: host, a_: path, a0: port_, a4: protocol, a5: query};
	});
...
var $author$project$CPU$initalCPU = {
	...
	ak: $author$project$Byte$mkByte(0),
	...
	return _Utils_Tuple2(
		{
			...
			P: true,
			ap: '',
			aW: $elm$core$Dict$fromList(_List_Nil),
			W: $elm$core$Dict$fromList(_List_Nil),
			N: false,
			Z: true
		},
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {a3: processes, bj: taggers};
	});
...
var $author$project$CPU$update = F2(
	function (opcode, cpu) {
		switch (opcode.$) {
			...
			case 12:
				var _byte = opcode.a;
				var ip = cpu.ad ? A2($author$project$Byte$byteAdd, cpu.d, 2) : _byte;
				return _Utils_update(
					cpu,
					{d: ip});
			case 13:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							B: true,
							e: mem,
							W: $author$project$Main$mappingDecoder(mes)
						}),
			...
			[
				...
				_List_fromArray(
					[
						...
						model.Z ? $author$project$Main$editor(model) : $author$project$Main$documentationNavigation),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($author$project$Main$displayByte, model.x, model.e.ak))
															])),
														A2(
														$elm$html$Html$td,
														_List_fromArray(
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																$author$project$Main$displayBool(model.e.ad))
															])),
														A2(
														$elm$html$Html$td,
														_List_fromArray(
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																$author$project$Main$displayBool(model.e.an))
															])),
														A2(
														$elm$html$Html$td,
														_List_fromArray(
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{bI: $author$project$Main$initialModel, b3: $author$project$Main$subscriptions, b7: $author$project$Main$update, b8: $author$project$Main$view});
